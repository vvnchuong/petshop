                                ...
                                <div class="col-12">
                                    <div class="card shadow-sm border-0">
                                        <div class="card-body p-4">
                                            <h3 class="mb-3">Thông tin chi tiết người dùng</h3>
                                            <hr />
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-8">
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item">
                                                            <span class="detail-key">Tên đăng nhập:</span>
                                                        ...
                                                        <li class="list-group-item">
                                                            <span class="detail-key">Vai trò:</span>
