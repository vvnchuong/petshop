                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="status" name="status" class="form-select">
                                            <option value="PENDING" ${order.status.toString() eq 'PENDING' ? 'selected'
                                                : '' }>Chờ xử lý</option>
                                            <option value="SHIPPING" ${order.status.toString() eq 'SHIPPING'
                                                ? 'selected' : '' }>Đang giao</option>
                                            <option value="DELIVERED" ${order.status.toString() eq 'DELIVERED'
                                                ? 'selected' : '' }>Đã giao</option>
                                            <option value="CANCELLED" ${order.status.toString() eq 'CANCELLED'
