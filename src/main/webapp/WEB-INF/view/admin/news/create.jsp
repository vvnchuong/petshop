...
<body class="sb-nav-fixed">
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm border-0">
                             <div class="card-body p-4">
                                <h4 class="card-title mb-3">Thêm bài viết mới</h4>
                                <hr/>
                                ...
                                <form:form action="/admin/news/create" method="post" modelAttribute="news"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" class="form-control" id="inputFile" name="inputFile"
                                            accept=".png,.jpg,.jpeg" onchange="previewThumb(event)">
                                        <div class="helper">Hỗ trợ .png, .jpg, .jpeg — Ảnh sẽ auto crop/fit khi hiển thị
                                        </div>
                                        <img id="thumbImg" class="thumb-preview" style="display:none"
    ...
    <script>
        ...
        class MyUploadAdapter {
            constructor(loader) {
                this.loader = loader;
                this.url = '/admin/news/upload-image'; // Giữ nguyên URL
            }
