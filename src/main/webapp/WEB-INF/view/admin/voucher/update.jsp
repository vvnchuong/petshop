                        ...
                        <form:form method="post" action="/admin/voucher/update/${id}" modelAttribute="currentVoucher"
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-md-6">
                              ...
                              <label class="form-label required">Giá trị đơn tối thiểu (VND)</label>
                              <form:input path="minOrder" type="number" min="0"
                                class="form-control ${not empty errorMinOrder ? 'is-invalid' : ''}"
                            ...
                            <div class="col-12">
                              <div class="form-text text-muted">
                                ...
                                <strong>Mức giảm cố định</strong>. Hệ thống sẽ tự khóa trường kia khi bạn nhập.
                              </div>
                            </div>
