        ...
        <body>
              ...
              <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-8">
                  ...
                  <c:if test="${not empty newsDetail.thumbnail}">
                    <img class="post-thumbnail img-fluid" src="/admin/images/thumbnail/${newsDetail.thumbnail}"
                  ...
                  <div id="comment-section">
                    ...
                    <form action="/news/comment" method="POST">
                      <input type="hidden" name="news.title" value="${newsDetail.title}">
                      <input type="hidden" name="news.slug" value="${newsDetail.slug}">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6 mb-3">
                          <label for="commentEmail" class="form-label">Email <span class="text-danger">*</span></label>
          ...
          <script>
            $(document).ready(function () {
              $('#comment-section form').submit(function (e) {
                e.preventDefault();
