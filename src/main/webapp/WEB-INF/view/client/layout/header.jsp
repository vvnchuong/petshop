                                    ...
                                    <div class="dropdown-menu mega-menu p-4">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <a class="dropdown-item" href="/shop-cho/thuc-an-hat-cho-cho">Thức ăn
                                                    hạt</a>
                                                <a class="dropdown-item" href="/shop-cho/pate-cho-cho">Pate</a>
                                                <a class="dropdown-item" href="/shop-cho/banh-thuong-cho-cho">Bánh
                                                    thưởng</a>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="fw-bold border-bottom pb-2">Vệ sinh & chăm sóc</h6>
                                                <a class="dropdown-item" href="/shop-cho/khay-ve-sinh-cho-cho">Khay vệ
                                                    sinh</a>
                                                <a class="dropdown-item" href="/shop-cho/sua-tam-cho-cho">Sửa tắm</a>
                                                <a class="dropdown-item" href="/shop-cho/cham-soc-tai-mat-mieng">Chăm
                                                    sóc tai/mắt/miệng</a>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="dropdown-menu mega-menu p-4">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <a class="dropdown-item" href="/shop-meo/thuc-an-hat-cho-meo">Thức Ăn
                                                    Hạt</a>
                                                <a class="dropdown-item" href="/shop-meo/pate-cho-meo">Pate</a>
                                                <a class="dropdown-item" href="/shop-meo/sup-thuong-cho-meo">Súp
                                                    Thưởng</a>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="fw-bold border-bottom pb-2">Vệ sinh, chăm sóc</h6>
                                                <a class="dropdown-item" href="/shop-meo/cat-ve-sinh-cho-meo">Cát Vệ
                                                    Sinh</a>
                                                <a class="dropdown-item" href="/shop-meo/nha-ve-sinh-cho-meo">Nhà Vệ
                                                    Sinh</a>
                                                <a class="dropdown-item" href="/shop-meo/sua-tam-cho-meo">Sữa Tắm</a>
                                            </div>
                                            <div class="col-md-4">
                                                <h6 class="fw-bold border-bottom pb-2">Phụ kiện, đồ chơi</h6>
                                                <a class="dropdown-item" href="/shop-meo/nha-cho-meo">Cào Móng & Đệm
                                                    Ngủ</a>
                                                ...
                                                <a class="dropdown-item" href="/shop-meo/vong-co-cho-meo">Vòng Cổ, Dây
                                                    Dắt</a>
                                                <a class="dropdown-item" href="/shop-meo/long-van-chuyen-cho-meo">Lồng
                                                    Vận Chuyển</a>
